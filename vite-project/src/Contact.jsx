        ...
        <div className="contact-social col-xl-6 col-lg-6 col-md-3 col-sm-3">
          ...
          <div className="contact-us no-wrap">
            <p>
              <a
                target="_blank"
                href="https://chat.whatsapp.com/KR7H8eUbruyBsQ8KSISBa0"
              >
            ...
            <p>
              <a
                target="_blank"
                href="https://www.facebook.com/eagleswings.church.5?mibextid=JRoKGi"
              >
                <FaFacebookSquare className="facebook" /> Click to join our
                Facebook community
              </a>
            </p>
            <p>
              <FaPhoneAlt /> 08032125130, 08130899786
            </p>
            <p>
              <MdOutlineEmail />
              akinolaolaoluwa@gmail.com
            </p>
          </div>
        </div>
      </div>
